...
class ServiceTask(Base):
    ...
    # Map pin (prefer pickup for open tasks)
    latitude = Column(Numeric(10, 7), nullable=True)
    longitude = Column(Numeric(10, 7), nullable=True)
    ...
    desired_delivery_at = Column(DateTime(timezone=True), nullable=True)
    # walk | ride | drive | auto
    travel_mode = Column(String(20), default="auto")
    # pending | to_pickup | picked_up | delivering | delivered
    delivery_phase = Column(String(20), default="pending", index=True)
    runner_latitude = Column(Numeric(10, 7), nullable=True)
    runner_longitude = Column(Numeric(10, 7), nullable=True)
    runner_location_updated_at = Column(DateTime(timezone=True), nullable=True)
    eta_seconds = Column(Integer, nullable=True)
    distance_meters = Column(Integer, nullable=True)
    accepted_at = Column(DateTime(timezone=True), nullable=True)
    picked_up_at = Column(DateTime(timezone=True), nullable=True)
    completed_at = Column(DateTime(timezone=True), nullable=True)
    late_complaint_at = Column(DateTime(timezone=True), nullable=True)
