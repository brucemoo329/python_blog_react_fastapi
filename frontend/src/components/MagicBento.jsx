...
/**
 * MagicBento — React Bits style animated card grid.
 * Pass `cards` to customize content; `onCardClick(card, index)` for navigation.
 */
const MagicBento = ({
  cards,
  onCardClick,
  ...
  const cardData = cards?.length ? cards : defaultCardData
